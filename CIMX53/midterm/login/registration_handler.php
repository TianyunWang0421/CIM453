...
if($hasErrors) {
  ...
  $sql = "INSERT INTO `users` (`id`, `first_name`, `last_name`,`email`,`password`, `address`, `address_2`, `city`, `state`, `zip`, `phone_number`) VALUES (NULL, '$firstName', '$lastName','$email','$password','$address', '$address_2', '$city', '$state', '$zip', '$phone_number')";
  echo $sql;
// Perform the query
