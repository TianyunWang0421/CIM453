...
function loadWysiwygJavascript() {
  ...
  $stableVersion = "4.6.7";  // for CDNs only - Latest "stable" version defined here: https://www.tinymce.com/docs/get-started-cloud/editor-plugin-version/#stablereleasestream
