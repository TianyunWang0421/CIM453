...
$comments = $_POST['comments'];
  ...
  $sql = "INSERT INTO `pizza_order` (`id`,`user_id`, `first_name`, `last_name`, `address`, `address_2`, `city`, `state`, `zip`, `phone_number`, `size`, `toppings`, `comments`, `order_total`) VALUES (NULL,'$user_id', '$firstName', '$lastName', '$address', '$address_2', '$city', '$state', '$zip', '$phone', '$size', '$toppings', '$comments', '$orderTotal')";
// Perform the query
