...
$comments = $_POST['comments'];
  ...
  $sql = "INSERT INTO `pizza_order` (`id`, `first_name`, `last_name`, `address`, `address_2`, `city`, `state`, `zip`, `phone_number`, `size`, `toppings`, `comments`, `order_total`) VALUES (NULL, '$firstName', '$lastName', '$address', '$address_2', '$city', '$state', '$zip', '$phone', '$size', '$toppings', '$comments', '$orderTotal')";
// Perform the query
